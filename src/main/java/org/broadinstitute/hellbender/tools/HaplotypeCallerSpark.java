...
public final class HaplotypeCallerSpark extends GATKSparkTool {
    ...
    protected void runTool(final JavaSparkContext ctx) {
        ...
        callVariantsWithHaplotypeCallerAndWriteOutput(getAuthHolder(), ctx, getReads(), getHeaderForReads(), getReference(), getReferenceSequenceDictionary(), intervals, hcArgs, shardingArgs, numReducers, output);
    }
     ...
     * @param referenceDictionary the reference dictionary to use
    ...
    public static void callVariantsWithHaplotypeCallerAndWriteOutput(
        ...
        if (hcArgs.emitReferenceConfidence == ReferenceConfidenceMode.GVCF) {
            ...
            writeVariants(output, variants, hcEngine, referenceDictionary, readsHeader.getSequenceDictionary());
        } else {
     ...
     */
    private static void writeVariants(String outputFile, JavaRDD<VariantContext> variants, HaplotypeCallerEngine hcEngine, SAMSequenceDictionary referenceDictionary, SAMSequenceDictionary readsDictionary) {
